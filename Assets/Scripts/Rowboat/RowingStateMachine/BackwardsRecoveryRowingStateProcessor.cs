...
namespace IndieCade
{
    public class BackwardsRecoveryRowingStateProcessor : RowingStateProcessor
    {
        ...
        public BackwardsRecoveryRowingStateProcessor(RowingStateMachineContext context, RowboatPlayerInputs rowboatPlayerInputs, RowboatPhysicsController rowboatPhysics, RowboatMaps rowboatMaps, GlobalDirectionStateMachine globalDirectionStateMachine)
