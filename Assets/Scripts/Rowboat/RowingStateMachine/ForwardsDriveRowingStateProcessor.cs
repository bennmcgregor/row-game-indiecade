...
namespace IndieCade
{
    public class ForwardsDriveRowingStateProcessor : RowingStateProcessor<RowingState, RowingStateMachineTransition>
    {
        ...
        public ForwardsDriveRowingStateProcessor(RowingStateMachineContext<RowingState, RowingStateMachineTransition> context, RowboatPlayerInputs rowboatPlayerInputs, RowboatPhysicsController rowboatPhysics, RowboatMaps rowboatMaps, GlobalDirectionStateMachine globalDirectionStateMachine)
