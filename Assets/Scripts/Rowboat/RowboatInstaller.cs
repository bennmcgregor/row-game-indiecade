...
namespace IndieCade
{
    public class RowboatInstaller : MonoInstaller 
    {
        ...
        public RowingStateMachine<RowingMotionState, RowingMotionStateMachineTransition> MakeRowingMotionStateMachineV1(RowboatMaps rowboatMaps, GlobalDirectionStateMachine globalDirectionStateMachine)
        {
        ...
        public RowingStateMachine<RowingMotionState, RowingMotionStateMachineTransition> MakeRowingMotionStateMachineV2(RowboatMaps rowboatMaps, GlobalDirectionStateMachine globalDirectionStateMachine)
        {
            RowingStateMachineContext<RowingMotionState, RowingMotionStateMachineTransition> context = new RowingStateMachineContext<RowingMotionState, RowingMotionStateMachineTransition>(RowingMotionState.ENTRY);
            ...
            forwardsRecovFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition)
                {
                    return transition == RowingMotionStateMachineTransition.STERN_DOWN || transition == RowingMotionStateMachineTransition.SHIFT_DOWN;
                },
                RowingMotionState.STOP,
                delegate
                {
                    _physicsController.StopRecovery();
                    _physicsController.StartStopBoat();
            ...
            forwardsDriveFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition)
                {
                    return transition == RowingMotionStateMachineTransition.STERN_DOWN || transition == RowingMotionStateMachineTransition.SHIFT_DOWN;
                },
            ...
            backwardsRecovFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition)
                {
                    return transition == RowingMotionStateMachineTransition.BOW_DOWN || transition == RowingMotionStateMachineTransition.SHIFT_DOWN;
                },
                RowingMotionState.STOP,
                delegate
                {
            ...
            backwardsDriveFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition)
                {
                    return transition == RowingMotionStateMachineTransition.BOW_DOWN || transition == RowingMotionStateMachineTransition.SHIFT_DOWN;
                },
            ...
            stopFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition)
                {
                    ...
                    return (transition == RowingMotionStateMachineTransition.BOW_DOWN &&
                        _rowboatPlayerInputs.InputStateMachines[sternKey].CurrentState == InputState.NONE &&
                        _rowboatPlayerInputs.InputStateMachines[InputKey.SHIFT].CurrentState == InputState.NONE &&
                        _physicsController.CanTransitionFromStopped())
                        ||
                        ((transition == RowingMotionStateMachineTransition.STERN_UP || transition == RowingMotionStateMachineTransition.SHIFT_UP) &&
                        (context.PreviousState == RowingMotionState.FORWARDS_RECOV || context.PreviousState == RowingMotionState.FORWARDS_DRIVE) &&
                        !_physicsController.CanTransitionFromStopped());
                },
                RowingMotionState.FORWARDS_RECOV,
            ...
            stopFactory.RegisterTransition(
                delegate (RowingMotionStateMachineTransition transition) {
                    ...
                    return (transition == RowingMotionStateMachineTransition.STERN_DOWN &&
                        ...
                        _physicsController.CanTransitionFromStopped())
                        ||
                        ((transition == RowingMotionStateMachineTransition.BOW_UP || transition == RowingMotionStateMachineTransition.SHIFT_UP) &&
                        (context.PreviousState == RowingMotionState.BACKWARDS_RECOV || context.PreviousState == RowingMotionState.BACKWARDS_DRIVE) &&
                        !_physicsController.CanTransitionFromStopped());
                },
                RowingMotionState.BACKWARDS_RECOV,
